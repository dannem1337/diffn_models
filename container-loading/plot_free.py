...
normal_df = normal_df[normal_df["configuration"] == "Huub_free"].copy()
basic_df = basic_df[basic_df["configuration"] == "Huub_free"].copy()
merge_df = merge_df[merge_df["configuration"] == "Huub_free"].copy()
seperate_df = seperate_df[seperate_df["configuration"] == "Huub_free"].copy()
...
# Show the plot
plt.savefig("free_plot.png", dpi=300)
