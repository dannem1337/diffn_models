...
schedule(
    instances= pathlib.Path("./huub_no_gen_bounds/instances_prod_shelf.csv"),
    output_dir=pathlib.Path("./results_optimized_new/results_prod_new"),
    timeout=timedelta(minutes=20),
    configurations=[
        Configuration(name="Huub_vsids_basic", solver=minizinc.Solver.load(pathlib.Path('./huub_basic/share/minizinc/solvers/huub.msc')), other_flags={"--vsids-only": True, "--restart true": True}),
        ...
        Configuration(name="Huub_vsids_no_gen_bounds", solver=minizinc.Solver.load(pathlib.Path('./huub_no_gen_bounds/share/minizinc/solvers/huub.msc')), other_flags={"--vsids-only": True, "--restart true": True}),
        ...
        Configuration(name="Huub_vsids_m+s", solver=minizinc.Solver.load(pathlib.Path('./huub_m+s/share/minizinc/solvers/huub.msc')), other_flags={"--vsids-only": True, "--restart true": True}),
        ...
        Configuration(name="Huub_vsids_m+o", solver=minizinc.Solver.load(pathlib.Path('./huub_m+o/share/minizinc/solvers/huub.msc')), other_flags={"--vsids-only": True, "--restart true": True}),
        ...
        Configuration(name="Huub_vsids_s+o", solver=minizinc.Solver.load(pathlib.Path('./huub_s+o/share/minizinc/solvers/huub.msc')), other_flags={"--vsids-only": True, "--restart true": True}),
        ...
        Configuration(name="Huub_vsids_basic", solver=minizinc.Solver.load(pathlib.Path('./huub_basic/share/minizinc/solvers/huub.msc')), other_flags={"--vsids-only": True, "--restart true": True}),
        Configuration(name="Huub_free_basic", solver=minizinc.Solver.load(pathlib.Path('./huub_basic/share/minizinc/solvers/huub.msc')), free_search=True),
        Configuration(name="Huub_vsids_decomp", solver=minizinc.Solver.load(pathlib.Path('./huub_decomp/share/minizinc/solvers/huub.msc')), other_flags={"--vsids-only": True, "--restart true": True} ),
