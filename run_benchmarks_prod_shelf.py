...
schedule(
    ...
    output_dir=pathlib.Path("./results_optimized/results_prod_new"),
    ...
    configurations=[
        ...
        Configuration(name="Huub_free_diffn", solver=minizinc.Solver.load(pathlib.Path('./huub_diffn/share/minizinc/solvers/huub.msc')), free_search=True ),
        ...
        # Configuration(name="Huub_free_no_gen_bounds", solver=minizinc.Solver.load(pathlib.Path('./huub_no_gen_bounds/share/minizinc/solvers/huub.msc')), free_search=True ),
    ],
